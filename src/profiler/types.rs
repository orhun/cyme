...
impl SystemProfile {
    ...
    pub fn flatten(&mut self) {
        let mut new_buses: Vec<Bus> = Vec::new();
    ...
    pub fn flatten_devices(&self) -> Vec<&Device> {
        let mut ret = Vec::new();
...
/// Recursively gets reference to all devices in a [`Device`]
pub fn get_all_devices(devices: &Vec<Device>) -> Vec<&Device> {
